...
def main():
    ...
    #the user, 
        ...
        csvRowString = ("SongID,AlbumID,AlbumName,ArtistID,ArtistLatitude,ArtistLocation,"+
            ...
            "Title,Year,NumBars,NumBeats,EndOfFadeIn,Energy,Key,Loudness,Mode,"+
            "NumSections,SegmentsLoudnessMax,SegmentsLoudnessMaxTime,NumSegments,"+
            "SongHotness,StartOfFadeOut,NumTatums,Track7DigitalID,TrackID")
        #################################################
    ...
    for root, dirs, files in os.walk(basedir):        
        ...
        for f in files:
            ...
            song.numBars = str(hdf5_getters.get_num_bars(songH5File))
            song.numBeats = str(hdf5_getters.get_num_beats(songH5File))
            ...
            song.numSections = str(hdf5_getters.get_num_sections(songH5File))
            ...
            song.numSegments = str(hdf5_getters.get_num_segments(songH5File))
            ...
            song.numTatums = str(hdf5_getters.get_num_tatums(songH5File))
            ...
            for attribute in csvAttributeList:
                ...
                elif attribute == 'NumBars'.lower():
                    csvRowString += song.numBars
                elif attribute == 'NumBeats'.lower():
                    csvRowString += song.numBeats
                ...
                elif attribute == 'NumSections'.lower():
                    csvRowString += song.numSections
                ...
                elif attribute == 'NumSegments'.lower():
                    csvRowString += song.numSegments
                ...
                elif attribute == 'NumTatums'.lower():
                    csvRowString += song.numTatums
                elif attribute == 'Track7DigitalID'.lower():
