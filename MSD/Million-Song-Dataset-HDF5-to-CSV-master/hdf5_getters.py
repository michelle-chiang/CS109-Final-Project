...
def get_num_segments(h5,songidx=0):
    """
    ...
    if h5.root.analysis.songs.nrows == songidx + 1:
        return len(h5.root.analysis.segments_start[h5.root.analysis.songs.cols.idx_segments_start[songidx]:])
    return len(h5.root.analysis.segments_start[h5.root.analysis.songs.cols.idx_segments_start[songidx]:
...
def get_segments_loudness_max(h5,songidx=0):
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return max(h5.root.analysis.segments_loudness_max[h5.root.analysis.songs.cols.idx_segments_loudness_max[songidx]:])
    return max(h5.root.analysis.segments_loudness_max[h5.root.analysis.songs.cols.idx_segments_loudness_max[songidx]:
...
def get_segments_loudness_max_time(h5,songidx=0):
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return max(h5.root.analysis.segments_loudness_max_time[h5.root.analysis.songs.cols.idx_segments_loudness_max_time[songidx]:])
    return max(h5.root.analysis.segments_loudness_max_time[h5.root.analysis.songs.cols.idx_segments_loudness_max_time[songidx]:
...
def get_num_sections(h5,songidx=0):
    """
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return len(h5.root.analysis.sections_start[h5.root.analysis.songs.cols.idx_sections_start[songidx]:])
    return len(h5.root.analysis.sections_start[h5.root.analysis.songs.cols.idx_sections_start[songidx]:
...
def get_num_beats(h5,songidx=0):
    """
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return len(h5.root.analysis.beats_start[h5.root.analysis.songs.cols.idx_beats_start[songidx]:])
    return len(h5.root.analysis.beats_start[h5.root.analysis.songs.cols.idx_beats_start[songidx]:
...
def get_num_bars(h5,songidx=0):
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return len(h5.root.analysis.bars_start[h5.root.analysis.songs.cols.idx_bars_start[songidx]:])
    return len(h5.root.analysis.bars_start[h5.root.analysis.songs.cols.idx_bars_start[songidx]:
...
def get_num_tatums(h5,songidx=0):
    """
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        return len(h5.root.analysis.tatums_start[h5.root.analysis.songs.cols.idx_tatums_start[songidx]:])
    return len(h5.root.analysis.tatums_start[h5.root.analysis.songs.cols.idx_tatums_start[songidx]:
